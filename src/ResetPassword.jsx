...
export default function PasswordResetVerification() {
  ...
  const handleResendCode = () => {
    ...
    axios.post("http://localhost:3000/api/resendEmail",{
      email
    })
    .then(response => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("http://localhost:3000/api/setNewPassword", {
        email,
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-4 lg:p-8">
          <div className="max-w-xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-blue-600">Reset Password</h2>
