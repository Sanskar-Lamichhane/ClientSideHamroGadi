...
// import { Calendar, Clock, MapPin, User, Truck, DollarSign, Tag, AlertCircle, Check, X, ChevronRight, Mail, Phone } from 'lucide-react';
...
//     axios.get(`http://localhost:3000/api/rental/${params.id}`,
//       {
//         headers: {
...
//     // Here you would handle the actual API call based on the action
//     console.log(`Confirmed ${confirmationAction} action`);
//     if (requiresReason) {
...
//       case 'in trip': return 'bg-blue-100 text-blue-800 border-l-4 border-blue-500';
//       case 'completed': return 'bg-purple-100 text-purple-800 border-l-4 border-purple-500';
//       case 'cancelled': return 'bg-red-100 text-red-800 border-l-4 border-red-500';
//       case 'rejected': return 'bg-gray-100 text-gray-800 border-l-4 border-gray-500';
...
//       case 'in trip': return <Truck className="text-blue-600" size={20} />;
//       case 'completed': return <Check className="text-purple-600" size={20} />;
//       case 'cancelled': return <X className="text-red-600" size={20} />;
//       case 'rejected': return <X className="text-gray-600" size={20} />;
...
//         {/* Status Banner */}
//         <div className={`w-full p-4 rounded-t-lg ${getStatusColor(currentStatus)}`}>
...
//               {currentStatus.toLowerCase() === 'cancelled' && rentalDetails.cancellation_message && (
...
//                       </div>
//                       <div>
//                         <div className="font-medium">{rentalDetails.vehicle.driver.name}</div>
//                         <div className="text-sm text-gray-600">{rentalDetails.vehicle.driver.noOfExperience} years experience</div>
//                       </div>
//                     </div>
...
//                 </div>
//                 <div className="p-4">
//                   <h3 className="font-medium text-lg mb-3">{rentalDetails.vehicle.make.brandName} {rentalDetails.vehicle.model} <span className="text-sm bg-gray-200 px-2 py-1 rounded ml-2">{rentalDetails.vehicle.year}</span></h3>
                  
//                   <div className="overflow-x-auto">
//                     <table className="w-full text-sm border-collapse">
//                       <tbody>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500 w-1/3">Registration Number</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.registration_number}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Color</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.color}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Capacity</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.capacity} seats</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Fuel Type</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.fuel_type}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Transmission</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.transmission}</td>
//                         </tr>
//                         <tr>
//                           <td className="py-2 px-3 text-gray-500">City</td>
//                           <td className="py-2 px-3">{rentalDetails.vehicle.city}</td>
//                         </tr>
//                       </tbody>
//                     </table>
//                   </div>
...
//                       <tbody>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500 w-1/3">Pick Up Date & Time</td>
//                           <td className="py-2 px-3">{formatDate(rentalDetails.pickUpDateTime)}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Pick Up Location</td>
//                           <td className="py-2 px-3">{rentalDetails.pickUpLocation}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Drop Off Date & Time</td>
//                           <td className="py-2 px-3">{formatDate(rentalDetails.dropOffDateTime)}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Drop Off Location</td>
//                           <td className="py-2 px-3">{rentalDetails.dropOffLocation}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Duration</td>
//                           <td className="py-2 px-3">{calculateDuration()} day{calculateDuration() > 1 ? 's' : ''}</td>
//                         </tr>
//                         <tr>
//                           <td className="py-2 px-3 text-gray-500">Journey Details</td>
//                           <td className="py-2 px-3">{rentalDetails.journey_details}</td>
//                         </tr>
//                       </tbody>
//                     </table>
//                   </div>
...
//                       <tbody>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500 w-1/3">Rate Per Day</td>
//                           <td className="py-2 px-3">NPR {rentalDetails.per_day.toLocaleString()}</td>
//                         </tr>
//                         <tr className="border-b border-gray-100">
//                           <td className="py-2 px-3 text-gray-500">Duration</td>
//                           <td className="py-2 px-3">{calculateDuration()} day{calculateDuration() > 1 ? 's' : ''}</td>
//                         </tr>
//                         <tr>
//                           <td className="py-2 px-3 text-gray-500 font-medium">Total Amount</td>
//                           <td className="py-2 px-3 font-medium">NPR {rentalDetails.price.toLocaleString()}</td>
//                         </tr>
//                       </tbody>
//                     </table>
//                   </div>
...
//                             <div className="font-medium">{rentalDetails.customer.name}</div>
//                             <div className="text-gray-600">{rentalDetails.customer.email}</div>
//                             <div className="text-gray-600">{rentalDetails.customer.phoneNumber}</div>
//                           </div>
//                         </div>
...
//                           <div className="space-y-1 text-sm">
//                             <div className="font-medium">{rentalDetails.vendor.name}</div>
//                             <div className="text-gray-600">{rentalDetails.vendor.email}</div>
//                             <div className="text-gray-600">{rentalDetails.vendor.phoneNumber}</div>
//                           </div>
//                         </div>
//                       </>
//                     )}
...
//               {/* For In Trip status - only vendor can mark as completed */}
//               {currentStatus.toLowerCase() === 'in trip' && userRole === 'vendor' && (
//                 <button 
...
//               {/* Reason input for cancel and reject */}
//               {requiresReason && (
//                 <div className="mb-4">
...
//                   disabled={requiresReason && !reasonText.trim()}
//                 >
//                   Yes
//                 </button>
//               </div>
...
const RentalDetailsPage = () => {
  ...
  const handleConfirmAction = () => {
    ...
    if (confirmationAction === "cancel") {
      ...
      axios.put(`http://localhost:3000/api/rental/${params.id}/cancel`, 
        { 
      ...
      const requestBody = confirmationAction === "reject" 
        ? { status: newStatus, rejection_message: reasonText }
        : { status: newStatus };
      
      axios.put(`http://localhost:3000/api/rental/${params.id}/status`, 
        requestBody,
        {
          headers: {
            Authorization: `Bearer ${token}`
      ...
      .then(res => {
        if (res.status === 200) {
          ...
          setRentalDetails(prev => ({
            ...prev,
            status: newStatus,
            ...(confirmationAction === "reject" && { rejection_message: reasonText })
          }));
      ...
      <div className="p-4">
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button
            ...
            disabled={isSubmitting || (requiresReason && !reasonText.trim())}
          >
