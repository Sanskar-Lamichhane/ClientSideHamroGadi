...
//        id === 'pickup-date' ? 'pickupDate' : 
//        id === 'return-date' ? 'returnDate' : id]: value
//     });
//   };
...
//     axios.get(`http://localhost:3000/api/vehicles?${searchParams.toString()}`)
//     .then(res=>{
...
//           <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6" onSubmit={handleSubmit}>
...
//               <div key={vehicle._id} className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
...
//                     <h3 className="text-xl font-bold text-gray-900">{`${vehicle.brandDetails.brandName} ${vehicle.model}`}
//                     </h3>
//                     <span className="text-lg font-bold text-blue-600">NPR {vehicle.price_per_day}/day</span>
//                   </div>
...
//                     </div>
//                     <div className="flex items-center text-gray-500 text-sm">
//                       <IoCarSportOutline className="mr-2" /> {vehicle.vehicle_type.categoryName}
//                     </div>
//                   </div>
//                   <Link 
//                     to={`/vehicle`}
...
//         <div className="max-w-7xl mx-auto">
//           <div className="text-center mb-12">
//             <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Our Fleet?</h2>
//             <p className="text-lg text-gray-600 max-w-3xl mx-auto">
//               We offer premium service and quality vehicles to ensure your journey is comfortable and reliable.
//             </p>
//           </div>
...
//               </div>
//               <h3 className="text-xl font-bold text-center text-gray-900 mb-4">Premium Fleet</h3>
//               <p className="text-gray-600 text-center">
//                 Our vehicles are regularly maintained and cleaned to ensure you have a comfortable and reliable ride. 
//                 All vehicles in our fleet are less than 3 years old.
//               </p>
//             </div>
...
//               </div>
//               <h3 className="text-xl font-bold text-center text-gray-900 mb-4">24/7 Support</h3>
//               <p className="text-gray-600 text-center">
//                 Our customer service team is available around the clock to assist with any questions or issues
//                 you might encounter during your rental period.
//               </p>
//             </div>
...
//               </div>
//               <h3 className="text-xl font-bold text-center text-gray-900 mb-4">Convenient Locations</h3>
//               <p className="text-gray-600 text-center">
//                 With pickup and drop-off points in major cities across the country, 
//                 we make it easy to get your vehicle wherever your journey begins.
//               </p>
//             </div>
//           </div>
//         </div>
...
const HomePage = () => {
  ...
  const handleInputChange = (e) => {
    const { id, value } = e.target;
    const field = id === 'location' ? 'city' : 
                 id === 'vehicle-type' ? 'vehicleType' : 
                 id === 'pickup-date' ? 'pickupDate' : 
                 id === 'return-date' ? 'returnDate' : id;
            ...
            <div className="lg:col-span-1">
              ...
              <div className="relative">
                ...
                {dateErrors.pickupDate && (
                  <p className="mt-1 text-sm text-red-600">{dateErrors.pickupDate}</p>
                )}
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="relative">
                ...
                {dateErrors.returnDate && (
                  <p className="mt-1 text-sm text-red-600">{dateErrors.returnDate}</p>
                )}
              </div>
            </div>
