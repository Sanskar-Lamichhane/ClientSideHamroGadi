...
const RentalConfirmation = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/api/rental/${id}`, {
        headers: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 flex flex-col">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">
                Your vehicle tour request is in process
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <span className="font-medium text-right text-gray-800">
                      {singleRentalDetails?.vehicle?._id || "Loading..."}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <span className="font-medium text-right text-gray-800">
                      {singleRentalDetails?.vehicle?.make?.brandName ||
                        "Loading..."}{" "}
                      {singleRentalDetails?.vehicle?.model || ""}{" "}
                      {singleRentalDetails?.vehicle?.year || ""}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <span className="font-medium text-right text-gray-800">
                      {formatDate(singleRentalDetails.pickUpDateTime) ||
                        "Loading..."}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <span className="font-medium text-right text-gray-800">
                      {formatDate(singleRentalDetails.dropOffDateTime) ||
                        "Loading..."}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex justify-between w-full">
                    ...
                    <span className="font-medium text-right text-gray-800">
                      {singleRentalDetails.pickUpLocation || "Loading..."}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-xl text-blue-700">
                    NPR {singleRentalDetails.price || "0"}
                  </span>
                </div>

                <div className="bg-gray-50 rounded-lg p-3 text-center mt-4">
                  <span className="text-sm text-gray-600">
                    Rental #{singleRentalDetails._id || "Processing..."}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-3 flex flex-col md:flex-row gap-4">
            <Link
              ...
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-xl flex items-center justify-center transition-colors text-lg font-medium shadow-md"
            >
            ...
            <Link
              to="/"
              className="flex-1 bg-white hover:bg-blue-50 text-blue-700 py-3 px-4 rounded-xl border border-blue-200 flex items-center justify-center transition-colors text-lg font-medium"
            >
