...
// import { Truck, Eye, Plus, Car, CheckCircle, XCircle } from 'lucide-react';
...
//             axios.get("http://localhost:3000/api/vehicles"+params.search)
//             .then(res=>{
...
//     // Sample unused vehicles data (only for admin)
//     const unusedVehicles = [
//         {
//             id: 4,
//             vehicleNo: 'KA05 XY 3456',
//             model: 'Hyundai Creta',
//             color: 'Blue',
//             type: 'SUV'
//         },
...
//                 {userRole === 'vendor' && (
//                     <Link to="/CreateVehicle"><button className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 flex items-center transition-colors">
...
//                                             </div>
//                                             <span className="font-semibold text-gray-900">{vehicle.registration_number}</span>
//                                         </div>
//                                     </td>
//                                     <td className="p-4 text-gray-700">{vehicle.model}</td>
//                                     <td className="p-4 text-gray-700">{vehicle.fuel_type}</td>
//                                     <td className="p-4 text-gray-700">{vehicle.color}</td>
//                                     <td className="p-4">
//                                     <span className={`
...
//                                         <td className="p-4 text-gray-700">{vehicle.color}</td>
//                                         <td className="p-4 text-right">
//                                             <button className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 flex items-center justify-center ml-auto transition-colors">
//                                                 <Eye size={16} className="mr-2" /> Delete
//                                             </button>
//                                         </td>
//                                     </tr>
//                                 ))}
