...
function IntripVehiclesDashboard() {
    ...
    const fetchIntripVehicles = () => {
        ...
        axios.post("http://localhost:3000/api/vendor/rentalList",
            ...
            console.log(err)
            setLoading(false);
            toast.error("Failed to load in trip vehicles", {
                position: "top-right",
                autoClose: 5000,
        ...
        axios.post("http://localhost:3000/api/admin/rentalList",
            ...
            console.log(err)
            setLoading(false);
            toast.error("Failed to load intrip vehicles", {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        <div className="dashboard p-6 bg-gray-50 font-sans">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="p-6 border-b bg-gradient-to-r from-blue-50 to-blue-100 flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-600 font-medium">Total InTrip: {vehiclesList.length}</span>
                </div>
                
                {loading ? (
                    <div className="p-8 text-center text-gray-500">Loading in trip vehicles...</div>
                ) : (
...
export default IntripVehiclesDashboard;