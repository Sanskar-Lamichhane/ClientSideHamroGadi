...
//                 toast.success('Booking submitted successfully! Your booking status isk pending', {
//                     position: "top-right",
//                     autoClose: 5000,
...
//                                 <span className="text-gray-700">Color: <span className="font-medium">{capitalizeFirstLetter(vehicleData.color)}</span></span>
//                             </div>
//                             <div className="flex items-center">
//                                 <span className="text-blue-500 mr-2">•</span>
//                                 <span className="text-gray-700">Fuel Type: <span className="font-medium">{capitalizeFirstLetter(vehicleData.fuel_type)}</span></span>
//                             </div>
//                             <div className="flex items-center">
//                                 <span className="text-blue-500 mr-2">•</span>
//                                 <span className="text-gray-700">Transmission: <span className="font-medium">{capitalizeFirstLetter(vehicleData.transmission)}</span></span>
//                             </div>
//                             <div className="flex items-center">
//                                 <span className="text-blue-500 mr-2">•</span>
...
//                             <div className="flex items-center">
//                                 <span className="text-blue-500 mr-2">•</span>
//                                 <span className="text-gray-700">City: <span className="font-medium">{capitalizeFirstLetter(vehicleData.city)}</span></span>
//                             </div>
//                             <div className="flex items-center">
//                                 <span className="text-blue-500 mr-2">•</span>
...
//                             <input
//                                 type="text"
//                                 className="w-full border p-3 rounded-lg focus:ring focus:ring-blue-200 focus:border-blue-500"
...
//                         {/* Journey Details */}
//                         <div className="mb-6">
//                             <label className="block text-gray-600 mb-2 font-medium">Journey Details</label>
//                             <textarea
//                                 className="w-full border p-3 rounded-lg focus:ring focus:ring-blue-200 focus:border-blue-500"
//                                 placeholder="Describe your journey purpose and requirements"
//                                 rows="3"
...
//                                     <span>{vehicleData.currency_type} {vehicleData.price_per_day} × {calculateRental().days} days</span>
//                                 </div>
//                                 <div className="flex justify-between font-bold text-lg text-blue-700 pt-2 border-t">
//                                     <span>Total:</span>
//                                     <span>{vehicleData.currency_type} {calculateRental().totalPrice.toFixed(2)}</span>
//                                 </div>
//                             </div>
//                         )}
...
//                             <h4 className="font-semibold mb-2">Vehicle Owner</h4>
//                             <div className="flex items-center">
//                                 <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-gray-500 font-bold mr-3">
//                                     {vehicleData.owner && vehicleData.owner.name ? vehicleData.owner.name.charAt(0) : 'O'}
//                                 </div>
//                                 <div>
//                                     <p className="font-medium">{vehicleData.owner ? vehicleData.owner.name : 'Owner'}</p>
//                                     <p className="text-gray-600 text-sm">Member since {vehicleData.createdAt ? new Date(vehicleData.createdAt).getFullYear() : 'N/A'}</p>
//                                 </div>
//                             </div>
//                         </div> */}
//                     </div>
...
// Modify the fetchVehicleData function to be callable from anywhere in the component
const fetchVehicleData = async () => {
    try {
        setLoading(true);
        const response = await fetch(`http://localhost:3000/api/vehicles/${id}`);
...
// Then in the form section - this remains the same as before
    // Image rendering helper function
    const renderImage = (imagePath, altText, className) => {
        if (imagePath) {
            return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="mb-6 bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmitReview}>
                            <div className="mb-4">
                                <label className="block text-gray-700 mb-2">Rating <span className="text-red-500">*</span></label>
                                <div className="flex mb-2">
                                    {[...Array(5)].map((_, i) => (
                                        <button
                                            type="button"
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    className={`w-full p-3 border rounded-lg focus:ring focus:ring-blue-200 focus:border-blue-500 ${reviewError && reviewText.trim() === '' ? 'border-red-500' : ''
                                        }`}
                                    rows="4"
                                    placeholder="Share your experience with this vehicle..."
                                    value={reviewText}
