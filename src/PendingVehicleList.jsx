...
function PendingVehiclesDashboard() {
  ...
  return (
    <div className="dashboard p-6 bg-gray-50 font-sans">
      ...
      <div
        className={`bg-white rounded-xl shadow-lg overflow-hidden ${userRole === "customer" ? "container" : ""}`}
      >
...
export default PendingVehiclesDashboard;
