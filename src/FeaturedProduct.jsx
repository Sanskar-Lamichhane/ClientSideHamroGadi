...
if (users){
    ...
    return (
       ...
       <Link to={`/product/${id}`}><div className="relative rounded bg-white border text-center shadow-mf group hover:bg-primary hover:border-primary">
            <img 
                src={INF} 
            ...
            <div className={`py-2 px-4 ${type === "latest" ? "flex items-center justify-between" : ""}`}>
                <p className="my-2 text-lg text-secondary font-semibold group-hover:text-white">{name}</p>
